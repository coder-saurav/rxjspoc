      ...
      {!!tasks.length &&
        tasks.map(task => (
          ...
          >
            ...
            {showSwitchButton && (
                <button name={task.id} className="btn btn-success btn-margin" type="button" onClick={handleSwitchClick}>
                {task.done ? "Undone" : "Done"}
                </button>
            )}
            {showRemoveButton && (
                <button name={task.id} className="btn btn-danger btn-margin" type="button" onClick={handleRemoveClick}>
                Remove
                </button>
            )}
          </li>
